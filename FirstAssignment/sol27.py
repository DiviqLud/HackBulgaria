def what_is_my_sign(day, month):
    ...
    if month == 5 and day in range(22, 32) or month == 6 and day in range(1, 22):
        return "Gemini"
    if month == 6 and day in range(22, 31) or month == 7 and day in range(1, 23):
        return "Cancer"
    if month == 7 and day in range(23, 32) or month == 8 and day in range(1, 23):
        return "Leo"
    ...
    if month == 1 and day in range(21, 32) or month == 2 and day in range(1, 20):
        return "Aquarius"
    if month == 2 and day in range(20, 29) or month == 3 and day in range(1, 21):
        return "Pisces"

print(what_is_my_sign(14, 4))
